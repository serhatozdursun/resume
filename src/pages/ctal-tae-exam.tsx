    ...
    <ThemeProvider theme={theme}>
      <div>
        ...
        <Script
          ...
          dangerouslySetInnerHTML={{
            __html: `
              ...
              gtag('js', new Date());
              gtag('config', '${env.GA_TRACKING_ID}', { page_path: '/ctal-tae-exam' });
            `,
          }}
        />
        ...
        <Helmet>
          ...
          <link
            rel='canonical'
            href='https://serhatozdursun.com/ctal-tae-exam'
          />

          <meta property='og:type' content='website' />
          <meta
            property='og:url'
            content='https://serhatozdursun.com/ctal-tae-exam'
          />
          <meta
            property='og:title'
          ...
          <script type='application/ld+json'>
            {JSON.stringify({
              ...
              url: 'https://serhatozdursun.com/ctal-tae-exam',
              description:
              ...
              breadcrumb: {
                ...
                itemListElement: [
                  ...
                  },
                  {
                    ...
                    position: 2,
                    name: 'ISTQB CTAL-TAE Sample Exam',
                    item: 'https://serhatozdursun.com/ctal-tae-exam',
                  },
                ],
              },
            })}
