        ...
        <div>
            <ThemeProvider theme={theme}>
                <Container>
                    ...
                    <Script src={`https://www.googletagmanager.com/gtag/js?id=G-0CSGDMK7CG`}
                        ...
                        <Header>
                            ...
                            <div>
                                <Info>
                                    ...
                                    <CommonLink id="email" href="mailto:serhat.ozdursun@gmail.com">
                                ...
                                <Info>
                                    <BoldText id="languages">Languages</BoldText>: Turkish (Native), English (C1),
                                    Spanish (B)
                                </Info>
                            </div>
                        </Header>
